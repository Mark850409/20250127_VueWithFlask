...
### v2.0.1 (2025-01-31)
#### Added
- 新增 Menu API 的錯誤處理和參數驗證
  - 檢查父選單是否存在
  - 防止選單設為自己的子選單
  - 刪除選單時檢查是否有子選單
- 新增 User API 的錯誤處理和參數驗證
  - 用戶名和郵箱唯一性檢查
  - 密碼長度和格式驗證
  - 用戶狀態驗證
- 新增 Log API 的錯誤處理和查詢功能
  - 新增獲取單條日誌接口
  - 新增獲取指定用戶日誌接口
  - 日誌按時間倒序排序

#### Changed
- 完善所有 API 的 OpenAPI 文檔
  - 添加詳細的參數說明
  - 添加請求和響應示例
  - 添加錯誤碼說明
- 優化錯誤處理和提示信息
...
#### 修復
- 修復 Git 推送功能的請求錯誤
  - 修正 push 和 force-push API 的請求格式
  - 添加遠程倉庫名稱和分支名稱參數
  - 修復 Content-Type header 設置
